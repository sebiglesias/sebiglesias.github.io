...
\section{Professional Summary}
    I am a seasoned Software Engineer with over eight years of experience designing and developing robust, scalable systems across cloud, back-end, and front-end technologies. With expertise in functional programming using React, Node.js, and TypeScript, I have led impactful projects that improved CI/CD pipelines and customer experiences, driving measurable growth. Additionally, my work with data-driven systems and microservices using Java, Spring, and PostgreSQL has honed my ability to deliver innovative solutions to complex challenges. I am seeking opportunities to leverage my technical and leadership skills to build transformative software products and contribute to a forward-thinking organization.
  ...
  \resumeSubHeadingListStart
    ...
    \resumeSubheading
      ...
      \resumeItemListStart
        ...
        \resumeItem{Laboratory I and II (3rd-year students):
    ...
    {Allaria+}{Buenos Aires, Argentina}
    \resumeItemListStart
        \resumeItem{Maintained and enhanced existing services written in Python (Django, FastAPI), Scala (Tapir, http4s, Cats), Java (Spring), TypeScript (Node.js), and PHP (CodeIgniter), scaling systems to support a growing client base by adding monitoring and open tracing using AWS/CloudWatch and Terraform. Developed internal tools for the Finance team, improving processes such as reconciliations, onboarding, checks, trade tickets, and receipts. Implemented a cryptocurrency trading platform (buy/sell) integrated with Allaria+ core systems. Improved and extended shared engineering libraries and contributed to web and mobile UI development using React Native.}
    \resumeItemListEnd
...
\section{Technical Skills}
 \begin{itemize}[leftmargin=0.15in, label={}]
    \small{\item{
     \textbf{Lenguajes}{: Java, Python, SQL (Postgres), JavaScript, HTML/CSS, R, Typescript, Scala, Bash, PHP, Kotlin} \\
     \textbf{Frameworks/librerias}{: React, Node.js, FastAPI, Django, JUnit, Spring, Express, PostHog, Tapir, Http4s, Cats} \\
     \textbf{Herramientas de Desarrollador}{: Git, GitHub, Docker, Jenkins, CircleCI, Google Cloud Platform (GCP), AWS, Intellij, Kubernetes, Nginx, Redis, Dynamo} \\
    }}
 \end{itemize}
%-------------------------------------------
