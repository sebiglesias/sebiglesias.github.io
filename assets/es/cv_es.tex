  ...
  \resumeSubHeadingListStart
    \resumeSubheading
      ...
      \resumeItemListStart
        ...
        \resumeItemListEnd
    \resumeSubheading
      {Ingeniero de Software}{Jun 2025 -- Presente}
      {Allaria+}{Buenos Aires, Argentina}
      \resumeItemListStart
      \resumeItem{Mantuve y mejoré servicios existentes en Python (Django y FastApi), Scala (Tapir, http4s, cats), Java (Spring), Typescript (Nodejs) y PHP(CodeIgniter), acorde a un mayor número de clientes agregando herramientas de monitoreo (open tracing) con AWS/Cloudwatch (terraform). Desarrollé herramientas internas para el área de Finanzas, mejorando procesos como conciliaciones, onboarding, cheques, boletos y comprobantes. Implementé una plataforma de compra/venta de criptomonedas integrada con los sistemas de Allaria+. Mejoré y agregué librerías compartidas del equipo de ingeniería y participé en desarrollos de UI web y mobile con React Native.}
      \resumeItemListEnd
    \resumeSubheading
      {Founding Ingeniero de Software}{Mar 2025 -- Jun 2025}
